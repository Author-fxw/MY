...
function AppBase:ctor(configs)
    self.configs_ = {
        ...
        -- defaultSceneName = "AboutScene",
        -- defaultSceneName = "player",
        defaultSceneName = "LoadingScene",
        -- defaultSceneName = "SettingScene",
        -- defaultSceneName ="HttpTextScene",
...
function AppBase:pushScene(sceneName, transition, time, more)
  
    local view = self:createView(sceneName)

    --print("enter "..sceneName)
    
    view:pushWithScene(transition, time, more)
    return view
end
